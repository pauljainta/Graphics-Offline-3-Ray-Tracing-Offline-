...
void capture()
{
    double Windowidth=pixels_along_both_dimensions, Windowheight=pixels_along_both_dimensions;
    ...
    image.save_image(image_file_path);
...
int main(int argc, char **argv){
	...
	init();
	scene_file_path="C:\\Users\\Jainta Paul\\Desktop\\1605022\\scene.txt";
	image_file_path="C:\\Users\\Jainta Paul\\Desktop\\1605022\\out.bmp";
	loadData();
